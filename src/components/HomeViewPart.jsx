...
const HomeViewPart = () => {
  ...
  return (
    <>
      <div className="text-white bg-[url('/homeImage.png')] bg-cover bg-center text-italic font-serif py-28">
        <ScrollTrigger
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col justify-center gap-2 text-center lg:text-start items-center lg:items-start">
              ...
              <div className="">
                ...
                <h1 className="2xl:text-6xl xl:text-5xl lg:text-4xl md:text-5xl text-4xl font-bold pt-4">
                  Jagadish Mistry
                </h1>
              ...
              <p className="text-hiLight lg:text-xl 2xl:w-[600px] md:w-[570px] pb-6 pt-3 font-semibold">
              ...
              <a
                ...
                className="text-secendry lg:py-4 py-2 lg:px-24 px-6 rounded-lg border border-secendry shadow-2xl shadow-slate-700/60 font-medium hover:scale-110 duration-300 text-italic lg:text-lg">
                DOWNLODE CV
              </a>
              {/* Counter ------------------- */}
