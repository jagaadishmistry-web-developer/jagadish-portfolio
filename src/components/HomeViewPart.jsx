    ...
    <>
      ...
      <div className="py-32 lg:pt-0 pt-44 lg:py-0 bg-secendry/5">
          <ScrollTrigger
            ...
            <div className="container mx-auto px-4 grid lg:grid-cols-2 xl:gap-12 lg:gap-16 gap-4 w-full capitalize">
              <div className="flex flex-col justify-center items-center lg:items-start">
                <div className="lg:text-2xl flex gap-2 text-bl dark:text-white mb-12">
                WELCOME
                <Typewriter
                ...
                <div className="duration-700 text-center lg:text-start">
                  <h2 className="lg:text-2xl text-lg font-medium text-black dark:text-white">HELLO EVERYONE, I&apos;M</h2>
                 ...
                 <div className="lg:text-lg mb-8 text-black dark:text-white text-center lg:text-start">
              ...
              <div className="lg:flex hidden py-24 items-center justify-center">
                <div className=" border-secendry/40">
