          ...
          <div data-aos="fade-up" className="lg:col-span-2 col-span-5">
            <div className="grid md:grid-cols-2 gap-3 w-full">
              {servicesData.map((sData) => (
                <div
                  key={sData.id}
                  className="flex items-center xl:gap-5 gap-3 xl:text-xl text-lg font-medium xl:px-6 px-3 hover:scale-105 duration-300 rounded-lg bg-black/5 text-white h-20 w-full">
